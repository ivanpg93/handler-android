...
import es.ivanpg93.error.ConnectError;
import es.ivanpg93.error.ConnectionError;
import es.ivanpg93.error.ResponseError;
import es.ivanpg93.error.TimeoutError;
import es.ivanpg93.error.UnknownHostError;
import es.ivanpg93.logging.LoggerInterceptor;
